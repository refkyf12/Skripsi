        ...
        <div class="content">
            <div class="toast align-items-center text-white bg-gray border-0" role="alert" aria-live="assertive"
                ...
                <div class="toast-body" style="font-size: 20px;">
                    Halo! Selamat datang ke pembelajaran. Dalam modul ini, kita akan belajar tentang
                    bagaimana menulis teks esai. Tujuan dari modul ini adalah membantu Anda
                    memahami langkah-langkah penting dalam menulis teks esai sehingga Anda dapat menyusunnya
                    dengan lebih baik.
