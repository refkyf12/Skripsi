...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <!-- Main content -->
        <div class="content">
            <form action="/quiz/post" method="POST">
                @csrf
                <div class="form-group">
                    <label for="exampleInputEmail1">Nama Quiz</label>
                    <input type="text" class="form-control" id="judul" aria-describedby="emailHelp" name="nama_quiz"
